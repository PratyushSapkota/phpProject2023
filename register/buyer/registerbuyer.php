            ...
            <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                <div class="card" style="border-radius: 15px;">
                    <div class="card-body p-5">
                        <h2 class="text-uppercase text-center mb-5">Create an account as Buyer</h2>

                        <form action="buyerdata.php" method="post">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <label class="form-label" for="form3Example1cg">Shipping Address</label>
                            </div>
